...
- The loader expects two phases in the file:
  - phase1: heap use — lines are "timestamp,HeapBytes,marker" e.g. "1000,12345678,true"
  - phase2: page dump — contains before/after GC blocks marked like "-------before GC 1 @ 1000 -------" and "-------after GC 1 @ 1000 -------"
