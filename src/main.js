...
sidebar.onOpenFile = async () => {
  ...
  fi.type = 'file'; fi.accept = '.csv,.json,text/csv,text/plain,application/json'; fi.multiple = true; fi.style.display = 'none';
...
dropOverlay.innerHTML = `<div class="message">释放文件以上传（支持多个 CSV 或 JSON）</div>`;
